( function (){
    ...
    */
    // ?
    function calculator(calcParam1, calcParam2) {
        return function(callback) {
            return callback(calcParam1, calcParam2);
        };
    }
    ...
    */
    ...
    console.log(sum( function( p1, p2 ){ 
            return p1 + p2;
         }) );
    ...
    */
    var substration = calculator(3,2);
    ...
    chamada.
    */
    console.log( 'O resultado da subtração 3-2 é: ' + substration(function(p1,p2) { return p1-p2}) );
    // ?

    console.log( 'O resultado da multiplicação 4x4 é: ' + multiplication(function(p1,p2) { return p1*p2}) );
    // ?

    console.log( 'O resultado da divisão 3/2 é: '  + division(function(p1,p2) { return p1/p2}) );
    // ?

    console.log( 'O resto da divisão 6/3 é: '  + mod(function(p1,p2) { return p1%p2}) );
    // ?
